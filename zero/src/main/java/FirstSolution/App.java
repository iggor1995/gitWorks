...
public class App 
{
    ...
    public static void main( String[] args ) throws IOException {
        ...
        int[][] matrix1 = new int[firstMatrixHeight][firstMatrixWidth];
        int[][] matrix2 = new int[secondMatrixHeight][secondMatrixWidth];
        app.matrixFill(matrix1);
        app.matrixFill(matrix2);
        System.out.println("first matrix");
        app.drawMatrix(matrix1);
        System.out.println("second matrix");
        app.drawMatrix(matrix2);
        System.out.println("result matrix");
        app.drawMatrix(app.multiply(matrix1, matrix2));
